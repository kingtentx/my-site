(function (window) {
    ...
    reg({ type: 'image', name: '图片', group: 'basic', icon: 'layui-icon-picture', defaults: { src: '', alt: '', link: '' }, inspector: [f('src','图片地址'), f('alt','替代文本'), f('link','跳转链接')] });
    ...
    reg({ type: 'video', name: '视频', group: 'basic', icon: 'layui-icon-video', defaults: { src: '', poster: '', controls: true }, inspector: [f('src','视频地址'), f('poster','封面地址'), f('controls','显示控件','checkbox')] });

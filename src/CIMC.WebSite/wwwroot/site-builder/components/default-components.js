(function (window) {
    ...
    reg({ type: 'text', name: '文本', group: 'basic', icon: 'layui-icon-edit', desc: '段落文本，支持换行', styleScope: SCOPE_TEXT, defaults: { text: '请输入文本内容' }, inspector: [f('text', '文本内容', 'textarea', { hint: '直接换行即可分段；前台保留换行' })] });

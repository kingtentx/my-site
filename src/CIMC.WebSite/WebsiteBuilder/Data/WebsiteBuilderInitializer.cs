    ...
    public class WebsiteBuilderInitializer
    {
        ...
        private static void SeedDefaults(WebsiteBuilderDbContext db)
        {
            ...
            if (!db.Pages.Any())
            {
                ...
                var componentJson = DefaultHomeComponentJson();
                var draftJson = DefaultPageJson(1, "首页", "/", layoutJson, componentJson);
                db.Pages.Add(new WebsitePage { SiteId = 1, PageName = "首页", PageCode = "home", PagePath = "/", PageTitle = "首页 - 企业官网", SeoKeywords = "企业官网,产品展示,新闻中心,招聘中心", SeoDescription = "企业官网首页，展示企业介绍、产品、新闻、招聘和联系方式。", LayoutJson = layoutJson, ComponentJson = componentJson, DraftJson = draftJson, PublishJson = draftJson, Status = (int)WebsiteContentStatus.Published, IsHome = true, Sort = 1, CreateTime = now, UpdateTime = now, PublishTime = now });
        ...
        private static string DefaultHomeComponentJson()
        {
            return """
            [
              { "id": "nav_001", "type": "navigation", "name": "顶部导航", "sort": 1, "visible": true, "locked": false, "props": { "siteName": "企业官网", "menus": [{ "title": "首页", "path": "/" },{ "title": "关于我们", "path": "/about" },{ "title": "产品中心", "path": "/products" },{ "title": "新闻中心", "path": "/news" },{ "title": "招聘中心", "path": "/jobs" },{ "title": "联系我们", "path": "/contact" }] }, "style": { "backgroundColor": "#ffffff", "textColor": "#333333", "activeColor": "#0d6efd" } },
              { "id": "banner_001", "type": "banner", "name": "首页 Banner", "sort": 2, "visible": true, "locked": false, "props": { "height": 520, "title": "专注企业数字化建设", "subtitle": "通过可视化建站、内容管理和组件化渲染提升官网维护效率", "buttonText": "了解更多", "buttonLink": "/about" }, "style": { "backgroundColor": "#0d6efd", "textColor": "#ffffff", "maskOpacity": 0.25 } },
              { "id": "richtext_001", "type": "richText", "name": "公司简介", "sort": 3, "visible": true, "locked": false, "props": { "title": "公司简介", "content": "这里展示企业介绍、核心能力、服务优势和发展方向。" }, "style": { "backgroundColor": "#ffffff", "paddingTop": 64, "paddingBottom": 64 } },
              { "id": "product_001", "type": "product", "name": "产品中心", "sort": 4, "visible": true, "locked": false, "props": { "title": "产品中心", "count": 6, "columns": 3, "showMore": true, "moreLink": "/products" }, "style": { "backgroundColor": "#f7f9fc", "paddingTop": 64, "paddingBottom": 64 } },
              { "id": "news_001", "type": "news", "name": "新闻中心", "sort": 5, "visible": true, "locked": false, "props": { "title": "新闻中心", "count": 6, "showCover": true, "showSummary": true, "showDate": true, "showMore": true, "moreLink": "/news" }, "style": { "backgroundColor": "#ffffff", "paddingTop": 64, "paddingBottom": 64 } },
              { "id": "job_001", "type": "job", "name": "招聘信息", "sort": 6, "visible": true, "locked": false, "props": { "title": "招聘信息", "count": 3, "showSalary": true, "showLocation": true, "showApply": true }, "style": { "backgroundColor": "#f7f9fc", "paddingTop": 64, "paddingBottom": 64 } },
              { "id": "footer_001", "type": "footer", "name": "页脚", "sort": 7, "visible": true, "locked": false, "props": { "companyName": "企业官网", "description": "企业官网可视化建站系统", "tel": "400-000-0000", "email": "service@example.com", "address": "广东省深圳市", "copyright": "Copyright © 企业官网 All Rights Reserved." }, "style": { "backgroundColor": "#111827", "textColor": "#ffffff" } }
            ]
            """;
        }
        ...
        {
            return $$"""[ { "id": "nav_001", "type": "navigation", "name": "顶部导航", "sort": 1, "visible": true, "locked": false, "props": { "siteName": "企业官网" }, "style": { "backgroundColor": "#ffffff", "textColor": "#333333", "activeColor": "#0d6efd" } }, { "id": "banner_001", "type": "banner", "name": "栏目 Banner", "sort": 2, "visible": true, "locked": false, "props": { "height": 320, "title": "{{title}}", "subtitle": "企业官网栏目页" }, "style": { "backgroundColor": "#0d6efd", "textColor": "#ffffff" } }, { "id": "richtext_001", "type": "richText", "name": "{{title}}", "sort": 3, "visible": true, "locked": false, "props": { "title": "{{title}}", "content": "{{content}}" }, "style": { "backgroundColor": "#ffffff", "paddingTop": 64, "paddingBottom": 64 } }, { "id": "footer_001", "type": "footer", "name": "页脚", "sort": 4, "visible": true, "locked": false, "props": { "companyName": "企业官网", "description": "企业官网可视化建站系统" }, "style": { "backgroundColor": "#111827", "textColor": "#ffffff" } } ]""";
        }

        private static string DefaultListComponentJson(string type, string title)
        {
            return $$"""[ { "id": "nav_001", "type": "navigation", "name": "顶部导航", "sort": 1, "visible": true, "locked": false, "props": { "siteName": "企业官网" }, "style": { "backgroundColor": "#ffffff", "textColor": "#333333", "activeColor": "#0d6efd" } }, { "id": "banner_001", "type": "banner", "name": "栏目 Banner", "sort": 2, "visible": true, "locked": false, "props": { "height": 320, "title": "{{title}}", "subtitle": "企业官网栏目页" }, "style": { "backgroundColor": "#0d6efd", "textColor": "#ffffff" } }, { "id": "{{type}}_001", "type": "{{type}}", "name": "{{title}}", "sort": 3, "visible": true, "locked": false, "props": { "title": "{{title}}", "count": 12, "columns": 3, "showMore": false }, "style": { "backgroundColor": "#ffffff", "paddingTop": 64, "paddingBottom": 64 } }, { "id": "footer_001", "type": "footer", "name": "页脚", "sort": 4, "visible": true, "locked": false, "props": { "companyName": "企业官网", "description": "企业官网可视化建站系统" }, "style": { "backgroundColor": "#111827", "textColor": "#ffffff" } } ]""";
        }
    }
}
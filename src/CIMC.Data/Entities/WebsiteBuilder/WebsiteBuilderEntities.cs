...
namespace CIMC.Data.Entities.WebsiteBuilder
{
    ...
    public class WebsiteSiteConfig
    {
        ...
        [MaxLength(100)] public string SiteName { get; set; }
        [MaxLength(500)] public string Logo { get; set; }
        [MaxLength(150)] public string BrowserTitle { get; set; }
        [MaxLength(500)] public string Keywords { get; set; }
        [MaxLength(1000)] public string Description { get; set; }
        [MaxLength(100)] public string IcpNo { get; set; }
        [MaxLength(100)] public string PoliceNo { get; set; }
        [MaxLength(50)] public string Tel { get; set; }
        [MaxLength(100)] public string Email { get; set; }
        [MaxLength(300)] public string Address { get; set; }
        [MaxLength(300)] public string Copyright { get; set; }
        [MaxLength(50)] public string Theme { get; set; }
    ...
    public class WebsitePage
    {
        ...
        [Required, MaxLength(100)] public string PageName { get; set; }
        [Required, MaxLength(100)] public string PageCode { get; set; }
        [Required, MaxLength(200)] public string PagePath { get; set; }
        [MaxLength(150)] public string PageTitle { get; set; }
        [MaxLength(500)] public string SeoKeywords { get; set; }
        [MaxLength(1000)] public string SeoDescription { get; set; }
        [MaxLength(500)] public string CanonicalUrl { get; set; }
    ...
    public class WebsiteNavigation
    {
        ...
        [MaxLength(50)] public string LinkType { get; set; } = "page";
        public int? PageId { get; set; }
        [MaxLength(300)] public string LinkUrl { get; set; }
        [MaxLength(20)] public string Target { get; set; } = "_self";
    ...
    public class WebsiteBanner
    {
        ...
        [MaxLength(100)] public string ButtonText { get; set; }
        [MaxLength(300)] public string ButtonLink { get; set; }
        [MaxLength(300)] public string LinkUrl { get; set; }
    ...
    public class WebsiteFooter
    {
        ...
        [MaxLength(50)] public string BackgroundColor { get; set; } = "#111827";
        [MaxLength(50)] public string TextColor { get; set; } = "#ffffff";
        public DateTime CreateTime { get; set; } = DateTime.Now;
        public DateTime UpdateTime { get; set; } = DateTime.Now;
    }
    ...
    public class ContentJob
    {
        ...
        [MaxLength(100)] public string JobType { get; set; }
    ...
    public class ContentJobApply
    {
        ...
        [MaxLength(100)] public string Email { get; set; }
        [MaxLength(500)] public string ResumeFile { get; set; }
    ...
    public class MaterialFile
    {
        ...
        [Required, MaxLength(500)] public string FileUrl { get; set; }
